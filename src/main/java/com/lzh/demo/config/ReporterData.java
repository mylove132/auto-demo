...
import com.lzh.demo.pojo.ReportBean;
import com.lzh.demo.utils.ReportUnits;
...
public class ReporterData {
    ...
    public ReportBean testContext(ITestContext context) {
        // 测试结果汇总数据
    ...
    public List<ReportBean> testResults(IResultMap map, int status) {
        // 测试结果详细数据
